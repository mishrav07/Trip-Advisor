...
llm = ChatGroq(model="qwen/qwen3.8-27b", max_tokens=512, api_key=GROQ_API_KEY)
...
# =========================
# Helper Fucntions and Constants
# =========================
KNOWN_AGENTS = {
    "flight_agent",
    "hotel_agent",
...
# =========================
# Adding a input Guardrails and Supervisor Agent to the
# travel planning tool. This agent will analyze the user input and determine if it is safe and appropriate for the travel planning context.
# It will also provide reasoning for its decisions and select which agents should be involved in the planning process.
# =========================
...
# This agent will generate the final travel response for the user.
# It will incorporate the human feedback if a revision was requested, and ensure that the final response is clear, practical,
# and useful for real travel planning.
# =========================
