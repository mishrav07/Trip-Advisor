...
# Default origin when user says only destination e.g. "I want to fly to New York" Germany Trip
# Change this if as per your default location

DEFAULT_ORIGIN_DATA = os.getenv(
    "DEFAULT_ORIGIN_DATA", "DE"
)  # Default origin country code (ISO 3166-1 alpha-2)
